...
<html>
 ...
 <body>
  ...
  <div class="container">    
     <br />
     <div class="jumbotron">
          <h2><center><img src="{{URL::asset('/pizza.png')}}" alt="profile Pic" height="50" width="50">Items</center></h2>
     ...
     <div align="right">
      ...
      <a href="{{ route('home') }}" type="button" name="home"  class="btn btn-primary btn-sm">Back to home</a>
            <a href="{{ route('Itrash') }}" type="button" name="home"  class="btn btn-danger btn-sm">Trash</a>
        ...
        <div class="modal-body">
         ...
         <form method="post" id="ItemForm" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            <label class="control-label col-md-4">Item Quantity : </label>
            <div class="col-md-8">
