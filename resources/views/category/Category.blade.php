...
<script src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>
 ...
 <body>
  ...
  <div class="container">    
     <br />
     <div class="jumbotron">
          <h2><center><img src="{{URL::asset('/cat.png')}}" alt="profile Pic" height="50" width="50">Category</center></h2>
     ...
     <div align="right">
      ...
      <a href="{{ route('Ctrash') }}" type="button" name="home"  class="btn btn-danger btn-sm">Trash</a>
